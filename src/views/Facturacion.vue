<template>
    <v-container>
        ...
        <div class="d-flex">
            ...
            <v-list class="w-50">
                <v-list-item v-for="(product, index) in productos" :key="index">
                    <div class="item-content justify-space-between">
                        <div class="pl-5 d-flex">
                            <v-img :src="product.imagen" style="width: 50px; height: 50px;" />
                        </div>
                        <div>
        ...
        <div class="d-flex justify-content-end">
            <v-btn @click="realizarCompra" class="mt-5 mb-10 w-25 bg-warning">Realizar Compra</v-btn>
        </div>
    </v-container>
</template>
