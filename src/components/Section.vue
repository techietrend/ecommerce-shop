<template>
    <v-row>
        <v-col v-for="(item, index) in items" 
            ...
            <v-card 
                   max-width="374"
                   class="card-hover p-2 bg-blue-lighten-5"
...
<script setup>
import mouse from '../assets/blackMouse.png'
import auriculares from '../assets/auris.png'
...
.card-hover:hover {
    ...
    box-shadow: 0px 0px 15px rgba(0, 0, 0, 5.3);
